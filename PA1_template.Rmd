...
paste ("Mean of number of steps taken each day = ",mean_sday)
paste ("Median of number of steps taken each day = ",median_sday)
```
...
paste ("Mean of number of steps taken each day = ",mean_sday_nona)
paste ("Median of number of steps taken each day = ",median_sday_nona)
```
